...
const v = {
	...
	y = { class: "p-2" },
	P = a("div", { class: "text-sm text-gray-700" }, "Text Color", -1),
	B = { class: "mt-1 grid grid-cols-8 gap-1" },
	F = ["aria-label", "onClick"],
	D = a("div", { class: "mt-2 text-sm text-gray-700" }, "Background Color", -1),
	w = { class: "mt-1 grid grid-cols-8 gap-1" },
	R = ["aria-label", "onClick"];
function T(t, j, z, A, E, n) {
	const i = d("Tooltip"),
		f = d("Popover");
	return (
		o(),
		l(
			...
			{ transition: "default" },
			{
				target: r(({ togglePopover: e, isOpen: s }) => [
					p(t.$slots, "default", C(b({ onClick: () => e(), isActive: s }))),
				]),
				"body-main": r(() => [
					a("div", y, [
						P,
